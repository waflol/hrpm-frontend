                            ...
                            <Row className="align-items-center">
                                <Col lg={7}>
                                    <div className="mb-4 pb-3 me-lg-5">
                                        ...
                                        <h1 className="display-5 fw-semibold mb-3">Find your dream jobs with <span className="text-primary fw-bold">JobF</span></h1>
                                    ...
                                    <Form action="#">
                                        <div className="registration-form">
                                            <Row className="g-0">
                                                ...
                                                <Col md={4} className="mb-3 mb-sx-3 mb-md-0">
