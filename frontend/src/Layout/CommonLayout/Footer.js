                    ...
                    <Row>
                        <Col lg={4}>
                            <div className="footer-item mt-4 mt-lg-0 me-lg-5">
                                <h4 className="text-white mb-4">JobFind</h4>
                    ...
                    <Row >
                        <Col lg={12}>
                            <p className="text-white-50 text-center mb-0">
                                {new Date().getFullYear()} &copy; JobFind - Job Finding and Recruiting Page <span> </span>
                                <a href='https://github.com/waflol/hrpm' target="_blank" rel='noreferrer' className="text-reset text-decoration-underline">Github</a>
                            </p>
                        </Col>
                    </Row>
                </Container>
