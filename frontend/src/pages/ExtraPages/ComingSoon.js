            ...
            <div>
                <div className="main-content">
                    <div className="page-content">
                        <MetaTags>
                            <title>Coming Soon | JobFind</title>
                        </MetaTags>
                                ...
                                <Row className="justify-content-center">
                                    <Col lg={6}>
                                        <div className="text-center">
                                            ...
                                            <p className="text-muted mb-4 pb-3">Start working with JobFind that can provide everything you need to generate awareness, drive traffic, connect.</p>
